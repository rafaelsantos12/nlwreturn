...
export function FeedbackContentStep({ feedbackType, onFeedbackRestartRequested, onFeedbackSuccess }: FeedbackContentStep){
    ...
    return(
        <> 
            <header>
                <button 
                type="button" 
                className=" top-5 lef-12 absolute text-zinc-400 hover:text-zinc-100"
