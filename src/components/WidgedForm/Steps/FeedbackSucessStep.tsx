...
interface onFeedbackSuccessProps {
    onFeedbackRestartRequested: () => void;
}

export function FeedbackSucessStep( {onFeedbackRestartRequested }:onFeedbackSuccessProps ){
    return(
        <>
            <header>
                <CloseButton/>
            ...
            <button
                ...
                className="py-4 px-6 mt-6 bg-zinc-800  rounded-md border-transparent text-sm leading-4 transition-colors 
                hover:bg-zinc-500   focus:outline-none focus:ring-2 focus:ring-offset-2
